/**
 * WARNING: Don't use 16 bit images in image_view. Use an image transport -> png instead. 
*/
...
// void ptRangeUtest(int range, double range_mult){
//         /**Calculated by:
...
//         * reinterpret_cast<pixel_type*>( //use a unit test to get a pt.range
